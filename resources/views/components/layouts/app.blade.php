        ...
        <main class="flex-1 ml-64">
            ...
            <header
                ...
                <div class="flex items-center gap-4">
                    ...
                    @if(auth()->user()->isAdmin())
                        <span
                            class="px-2 py-1 bg-purple-600/20 text-purple-400 text-xs font-semibold rounded-full border border-purple-600/30">Administrateur</span>
                    @elseif(auth()->user()->isManager())
                        <span
                            class="px-2 py-1 bg-blue-600/20 text-blue-400 text-xs font-semibold rounded-full border border-blue-600/30">Gérant</span>
                    @endif
                </div>
            </header>
